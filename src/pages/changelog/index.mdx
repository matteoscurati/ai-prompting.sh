...
title: 'ai-prompting changelog — release history & semver'
description: 'Release history for ai-prompting, the LLM prompt-improvement Skill. Tracked in Keep a Changelog format and following Semantic Versioning (semver).'
path: '/changelog'
---
...
[`CHANGELOG.md`](https://github.com/matteoscurati/ai-prompting/blob/main/ai-prompting/CHANGELOG.md)
